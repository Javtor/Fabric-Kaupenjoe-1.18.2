package io.github.javtor.javtormod.block.custom;
...
public class SpeedyBlock extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if(world.isClient()) {
            ...
            if(hand == Hand.MAIN_HAND) {
                player.sendMessage(new LiteralText("SERVER: This is THE SERVER! MAIN HAND!"), false);
            } else {
                player.sendMessage(new LiteralText("SERVER: This is THE SERVER! OFF HAND!"), false);
            }
        }
